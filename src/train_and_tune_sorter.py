...
# CONFIGURATION
# ==========================================
sigA = pd.read_csv("data/new raw/val_TTBarLep_120.csv")
sigB = pd.read_csv("data/new raw/val_WtoQQ_120.csv")
...
val_signal.to_csv("data/new raw/val_signal.csv", index=False)

CONFIG = {
    # Paths to your data


    "path_train_bg": "data/new raw/train_bg_QCD.csv",  
    "path_val_bg": "data/new raw/val_bg_QCD.csv",      
    "path_val_signal": "data/new raw/val_signal.csv",      
...
def main():
    ...
    clf = Pipeline([
        ('scaler', RobustScaler()), # Forces all kinematics to N(0,1)
    ...
    final_config = {
        ...
        "fpr": float(best_fpr),
        "bg_removed_fraction": float(bg_removed_fraction), # <--- SAVED HERE
