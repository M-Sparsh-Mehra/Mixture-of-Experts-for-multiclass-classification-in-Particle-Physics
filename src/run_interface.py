...
def main():
    ...
    expert_ttlep = load_trained_expert(os.path.join(PROJECT_ROOT, "models/expert_weights/expert_ttlep_signal.pt"))
    
    # REPLACE "expert_Signal_B.pt" with whatever you named your second signal's file
    expert_wtoqq = load_trained_expert(os.path.join(PROJECT_ROOT, "models/expert_weights/expert_wtoqq_signal.pt")) 
    ...
    test_csv = os.path.join(PROJECT_ROOT, "data/new raw/train_TTBarLep.csv") 
